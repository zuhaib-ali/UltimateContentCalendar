    ...
    <div class="bg">
        <div class="white-bg bg-light">
            <div class="container-fluid">
                <!-- NAV BAR -->
                <nav class="navbar navbar-light " style="display:block; font-size: 20px; font-weight: 600;">
                    <a class="navbar-brand" href="#">
                        <img src="{{ asset('logo.png') }}" alt="" style="width:50px;">
                    </a>
        ...
        <div class="containerr">
            <div class="formy ">
                ...
                <form action="{{ route('authenticate') }}" method="POST" class="">
                    ...
                    <input type="email" name="email" id="email" value="{{ old('username') }}" placeholder="E-Mail"
                        class="p-2 mt-4">
